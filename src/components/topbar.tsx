...
export default function Topbar() {
  ...
  return (
    <>
      <header className="h-16 bg-white/80 backdrop-blur-md border-b border-gray-200/80 flex items-center justify-between px-6 fixed top-0 left-64 right-0 z-30">
        <div className="flex items-center gap-4" ref={searchRef}>
          <div className="relative">
            ...
            <input
              ...
              className="pl-9 pr-8 py-2 bg-gray-50 border border-gray-200 rounded-lg text-sm w-72 focus:outline-none focus:ring-2 focus:ring-[#0B2545]/20 focus:border-[#0B2545] transition-all"
            />
            {search && (
        ...
        <div className="flex items-center gap-4">
          <select
            ...
            className="px-3 py-2 bg-[#0B2545]/5 border border-[#0B2545]/20 rounded-lg text-sm font-medium text-[#0B2545] cursor-pointer focus:outline-none focus:ring-2 focus:ring-[#0B2545]/20 transition-all"
          >
            {campuses.map((c) => (
